...
with open('test_one_ticker.csv', 'w') as output_file:
	...
	for ticker in ticker_list:
		...
		try: 
			...
			output_name = str(ticker_object.info['shortName'])
...
with open ('test_one_ticker.csv', 'a', newline='') as f_object:
